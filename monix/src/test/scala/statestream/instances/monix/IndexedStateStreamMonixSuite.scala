...
trait IndexedStateStreamMonixSuite[G[_]]
    extends IndexedStateStreamSuite[Observable, G, Task, Task]
    with BeforeAndAfterAll {

  override implicit def F: TupleStream[Observable, Task, Task] = statestream.instances.monix.monixInstances
